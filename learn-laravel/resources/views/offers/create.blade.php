                ...
                <div class="card-body ">
                    ...
                    <!-- Title Input -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" value="{{old('price')}}" id="price" name="price" placeholder="Price">
                            @error('price')
                            <p class="p-2" style="color: red">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 image-preview">
                            ...
                            <div class="">
                                <img class="px-5 py-2 object-fit-cover rounded-4" width="100%" src="{{asset(\App\Models\Offer::PLACEHOLDER_IMAGE_PATH)}}" alt="placeholder">
                            </div>
